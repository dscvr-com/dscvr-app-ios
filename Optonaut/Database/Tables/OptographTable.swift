...
struct OptographSchemaType: ModelSchema {
    ...
    let createdAt = Expression<Date>("optograph_created_at")
    let updatedAt = Expression<Date>("optograph_updated_at")
    let deletedAt = Expression<Date?>("optograph_deleted_at")
