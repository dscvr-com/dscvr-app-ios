...
extension UIColor {
    ...
    var hatched1: UIColor {
        get {
            ...
            let rect = CGRect(origin: CGPoint.zero, size: pattern.size)
            ...
            context.clip(to: rect, mask: pattern.cgImage!)
            context.fill(rect)
    ...
    fileprivate static func getColorComponents(_ value: Int) -> (red: CGFloat, green: CGFloat, blue: CGFloat) {
